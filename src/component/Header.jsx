  ...
  return (
    <div className="w-full">
      <div className="md:w-[1152px] px-2 md:px-0 mx-auto flex justify-between items-center h-[80px]">
        ...
        <div className={`cursor-pointer text-2xl md:flex gap-5 items-center text-gray-900 ${showMenu?"flex flex-col absolute left-0 top-52 text-white p-2 bg-slate-900 w-full z-50":"hidden"}`}>
